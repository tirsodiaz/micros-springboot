...
@Configuration
public class FiltroCors {//para paliar el defecto en POST Body se dan permisos en el headers
		...
		private static final String ALLOWED_ORIGIN = "*"; //Exige quitar @CrossOrigin(origins="*") de Controller
